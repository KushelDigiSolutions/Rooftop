                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="requirement_type" id="requirement_type" class="form-control">
                            ...
                            <option value="Maintenance">New Construction</option>
                    ...
                    <div class="mb-3">
						...
						<div class="col-md-6" id="other_source_input" style="display: none;">
						<div class="mb-3">
							<label for="other_lead_source" class="form-label">Referral By</label>
													 <select name="user_id" id="other_lead_source" class="form-control">
                            <option value="">Select One</option>
...
<script>
    ...
    if ($(this).val() === 'Others') {
        ...
        $('#other_lead_source').attr('required', true);
    } else {
        $('#other_source_input').hide();
        $('#other_lead_source').val('');
        $('#other_lead_source').removeAttr('required');
    }
});
        ...
        $("#contact-form1").validate({
            ...
            messages: {
                ...
                pincode: {
                    ...
                    minlength: "Enter 5 digit pincode",
                    maxlength: "Enter 5 digit pincode"
                },
