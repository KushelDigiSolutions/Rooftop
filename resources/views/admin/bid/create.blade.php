      ...
      function Add_section(sectionCount) {
          ...
          let sectionHtml = `<div class="addSectionDiv" id="section_${sectionCount}">
                              <div class="newsection">
								  ...
								  <div class="w-100 me-3">
                                          <label for="SectionNameInput" class="form-label mb-1">Description</label>
                                          <input type="text" name="description[${sectionCount}]" class="form-control w-100" id="SectionNameInput" required>
                                      </div>
