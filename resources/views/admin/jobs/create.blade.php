...
@section('content')
    <div class="dataOverviewSection mt-3 mb-3">
        <form action="{{ route('job.store') }}" method="POST" enctype="multipart/form-data" class="mt-3" id="productForm">
            @csrf
            <div class="dataOverview mt-3">

                <h6 class="m-0">Add New Job</h6>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-4">
                        <label for="source" class="form-label mb-1">Source<span class="text-danger">*</span></label>
