...
@section('title', 'Work After List')

@section('content')

<div class="dataOverviewSection mt-3">
    <div class="section-title">
        <h6 class="fw-bold m-0">All Work After <span class="fw-normal text-muted">({{-- $totalProducts --}})</span></h6>
        <a href="{{ route('work_after.create') }}" class="primary-btn addBtn">+ Add
            Work After</a>
    </div>
