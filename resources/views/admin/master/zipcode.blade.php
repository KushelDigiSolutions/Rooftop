                ...
                <form action="{{ route('zipcodes.store') }}" method="POST" id="zipcodeForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-1 w-100">
                           ...
                           <!-- <input type="text" class="form-control w-100" id="StateInput" name="state" value="Missouri" readonly> -->
							<select	class="form-control w-100" id="StateInput" name="state" required>
                        ...
                        <div class="mb-1 w-100">
                            ...
                            <select class="form-control w-100" id="StatusInput" name="status" required>
                                <option value="" disabled selected>Select Status</option>
            ...
            <div class="modal-content">
                ...
                <form  method="POST" id="editzipcodeForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-1 w-100">
                            <label for="StatusInput" class="form-label mb-1">Status <span class="text-danger">*</span></label>
                            <select class="form-control w-100" id="editStatusInput" name="status" required>
                                <option value="" disabled selected>Select Status</option>
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
