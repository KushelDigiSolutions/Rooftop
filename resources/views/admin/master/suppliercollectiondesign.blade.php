...
@section('title', 'Manage Vendor Brand Design')
@section('content')
<div class="dataOverviewSection mt-3">
    <div class="section-title">
        <h6 class="fw-bold m-0">All Product Design / Specification <span class="fw-normal text-muted"></span></h6>
        <a href="#" class="primary-btn addBtn" data-bs-toggle="modal" data-bs-target="#addSupplierCollectionDesignModal">+
            Add Vendor Brand Design</a>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addSupplierCollectionDesignModalLabel">Add Product Design / Specification</h1>
    ...
    <div class="modal-body">
        ...
        <div class="mb-1 w-100">
            <label for="supplierCollectionSelect" class="form-label mb-1">Vendor Brand <span class="text-danger">*</span></label>
            <select class="form-control w-100" id="supplierCollectionSelect" name="supplier_collection_id" required>
                <option value="" disabled selected>Select Vendor Brand</option>
        ...
        <!-- Design Input -->
        <div class="mb-1 w-100">
            <label for="SupplierCollectionDesignInput" class="form-label mb-1">Product Design / Specification <span class="text-danger">*</span></label>
                ...
                <thead>
                    <tr>
                        <th style="border-top-left-radius: 6px; border-bottom-left-radius: 6px;"
                            scope="col">S/N</th>
                        <th scope="col">Product Design / Specification</th>
                        <th scope="col">Vendor Brand</th>
