...
@section('title', 'Manage Vendors Brand')
@section('content')
<div class="dataOverviewSection mt-3">
    <div class="section-title">
        <h6 class="fw-bold m-0">All Vendors Brand <span class="fw-normal text-muted"></span></h6>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addCollectionModalLabel">Add Vendor Brand</h1>
                ...
                <form action="{{ route('supplier-collections.store') }}" method="POST" id="collectionForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-1 w-100">
                            <label for="CollectionInput" class="form-label mb-1">Vendor Brand <span class="text-danger">*</span></label>
