...
@section('title', 'Sub Contractors List')
...
@section('content')
    ...
    <div class="dataOverviewSection mt-3">
        <div class="section-title">
            <h6 class="fw-bold m-0 custem">All Sub Contractors<span class="fw-normal text-muted">({{-- count($users) --}})</span>
            </h6>
            <a href="{{ route('subContractors.create') }}" class="primary-btn addBtn">+ Add Sub Contractors</a>
        </div>
        ...
        {{-- <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form id="editUserForm" method="POST" action="{{ route('user.update', ['user' => '__user_id__']) }}"
                        autocomplete="off">
                        @csrf
                        @method('PUT')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form id="changePasswordForm" method="POST"
                        action="{{ route('user.change-password', ['user' => '__user_id__']) }}" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-1 w-100">
                                ...
                                <div class="input-group w-100">
                                    <input type="password" class="form-control border-0" id="current_password"
                                        name="current_password" required>
                                    <button class="btn bg-transparent border-0 toggle-password" type="button"
                                        data-target="current_password">
                                        <i class="bi bi-eye-slash"></i>
                                    </button>
                                </div>
                                <div class="form-text text-danger" id="current_password_error"></div>
                                <!-- Validation message -->
                            </div>
                            <div class="mb-1 w-100">
                                ...
                                <div class="form-text text-danger" id="new_password_error"></div>
                                <!-- Validation message -->
                            </div>
                            <div class="mb-1 w-100">
                                <label for="new_password_confirmation" class="form-label mb-1">Confirm New Password</label>
                                <div class="input-group w-100">
                                    <input type="password" class="form-control border-0" id="new_password_confirmation"
                                ...
                                <div class="form-text text-danger" id="new_password_confirmation_error"></div>
                                <!-- Validation message -->
                            </div>
                        </div>
                        <div class="modal-footer">
        ...
        <table class="table" id="projectsTable">
            ...
            <tbody>
                @if ($customers->isEmpty())                                    
                    <tr>
                        <td colspan="13" class="text-center">No Sub Contractorss found.</td>
                    </tr>
                @else
                    @foreach($customers as $customer)
                        @php $role = $customer->getRoleNames()->first() ?? 'No Role'; @endphp
                        <tr>
                            <td>{{ $customer->id }}</td>
                            <td>{{ $customer->name }}</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item small editBtn" href="#" 
                                        ...
                                        <li>
                                            <a class="dropdown-item small" href="#" 
                                                data-id="{{ $customer->id }}" 
                                                data-bs-toggle="modal" data-target="#changePasswordModal">
                                                Change Password
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item small deleteBtn" href="#" 
