...
@section('content')
    <div class="dataOverviewSection mt-3 mb-3">
        <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data" class="mt-3"
            id="productForm">
            @csrf
            <div class="dataOverview mt-3">
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        <label for="name" class="form-label m-0 mb-1">Customer Name<span
                ...
                <div class="mt-3 d-flex gap-3 mb-4">
                    <button type="submit" class="btn primary-btn">Create Customer</button>
