    ...
    <div class="nav">
        <div class="menu w-100">
            <ul class="p-0">
                @if (Auth::user()->getRoleNames()[0] == 'Super Admin')
                    ...
                    <li class="{{ request()->is('bids') ? 'active' : '' }}">
                        <a href="{{ route('quotations.list') }}">
                            <i class="bi bi-tools"></i><span class="text">Customer Bid</span>
                        </a>
                    </li>
				<li class="#">
                        <a href="#">
                            <i class="fa fa-building"></i><span class="text">Customer Contract (DocuSign)</span>
                        </a>
                    </li>
                    <li class="{{ request()->is(['sub_contractor','create/sub_contractor']) ? 'active' : '' }}">
                        <a href="{{route('sub_contractor')}}">
                            <i class="fa fa-building"></i><span class="text">Sub Contractors</span>
                        </a>
                    </li>
                    <li class="{{ request()->is(['jobs']) ? 'active' : '' }}">
                        <a href="{{route('jobs.list')}}">
                            <i class="fa fa-briefcase"></i><span class="text">Jobs</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="#?">
                            <i class="fa fa-calendar-alt"></i><span class="text">Appointments</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="#?">
                            <i class="fa fa-file-invoice"></i><span class="text">Quick Book</span>
                        </a>
                    </li>
                    <li class="{{ request()->is('zipcodes*') || request()->is('product-types*') || request()->is('suppliers*') || request()->is('supplier-collections*') || request()->is('supplierCollectionDesigns*') || request()->is('compositions*') || request()->is('types*') || request()->is('usages*') || request()->is('design-types*') ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            <li class="{{ request()->is('zipcodes') ? 'active' : '' }}">
                                <a href="{{ route('zipcodes.index') }}"><span class="text">Address</span></a>
                            </li>
                            ...
                            <li class="{{ request()->is('supplier-collections') ? 'active' : '' }}">
                                <a href="{{ route('supplier-collections.index') }}"><span class="text">Vendor Brands</span></a>
                            </li>
                            {{-- <li class="{{ request()->is('supplierCollectionDesigns') ? 'active' : '' }}">
                                <a href="{{ route('supplierCollectionDesigns.index') }}"><span class="text">Product Design / Specification</span></a>
                            </li> --}}
                ...
                @endif
                @if (Auth::user()->getRoleNames()[0] == 'Sub Contractor')
                    <li class="{{ request()->is('dashboard') ? 'active' : '' }}"><a href="{{ route('super.admin.dashboard') }}"><i class="bi bi-house"></i><span class="text">Dashboard</span></a></li>
                    <li class="{{ request()->is('jobs') ? 'active' : '' }}">
                        <a href="{{route('jobs.list')}}">
                            <i class="bi bi-building-add"></i><span class="text">Jobs</span>
                        </a>
                    </li>
                   {{-- <li class="{{ request()->is('leads.list.index') ? 'active' : '' }}"><a href="{{ route('leads.list.index') }}"><i class="bi bi-journal"></i></i><span class="text">Appointments</span></a></li>
                    <li class="{{ request()->is('quotations') ? 'active' : '' }}">
                ...
                @if (Auth::user()->getRoleNames()[0] == 'Customer')
                    <li class="{{ request()->is('dashboard') ? 'active' : '' }}"><a href="{{ route('super.admin.dashboard') }}"><i class="bi bi-house"></i><span class="text">Dashboard</span></a></li>
                    <li class="{{ request()->is('my-bid') ? 'active' : '' }}">
                        <a href="{{route('myBid.list')}}">
                            <i class="bi bi-tools"></i><span class="text">My Bid</span>
                        </a>
                    </li>

                    <li class="{{ request()->is('my-contract') ? 'active' : '' }}">
                        <a href="{{route('myContract.list')}}">
                            <i class="fa-solid fa-file-contract"></i><span class="text">Contract Review</span>
                        </a>
                    </li>

                    <li class="{{ request()->is('orders') ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-map-marker" ></i><span class="text">Project Tracker</span>
                        </a>
                    </li>
...
<li class="{{ request()->is('orders') ? 'active' : '' }}">
                        <a href="#">
                            <i class="bi bi-truck"></i><span class="text">Orders History</span>
                        </a>
                    </li>
                @endif
