...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('rooftop_logo.png') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('admin/CSS/multiselectInput.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/CSS/searchableInput.css') }}">
