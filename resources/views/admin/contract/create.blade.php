...
<script>
    // Blade variable ko JavaScript variable mein assign karna
    var totalAmount = {{ round(($total + $gst_amount) - $per_item_total_discount) }};
    
    console.log(totalAmount);  // Ye value ab aapke JavaScript variable mein hogi
    $('#bidAmount').text('$ ' + totalAmount.toFixed(2));
</script>
@endsection