    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('appointments.assign') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="approveFranchiseModalLabel">Assign Franchise</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('appointments.reassign') }}" method="POST" id="re_Assign">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="reapproveFranchiseModalLabel">Re-Shedule Franchise</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="date" class="form-label">Appointment Date<span class="requried">*</span></label>
                        <input type="datetime-local" name="dateFilter1" class="form-control appointment_date" id="re-dateFilter" placeholder="Filter by date" value="{{ request('dateFilter') }}" min="{{ $now }}" class="form-control me-3 w-100">
                        <div class="error" style="color: red;"></div>
                    </div>
                    ...
                    handler: function (response) {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                setTimeout(() => {
                                    window.location.href = 'https://curtainsandblinds.in/orders';
