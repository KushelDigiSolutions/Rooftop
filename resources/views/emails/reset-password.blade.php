                 ...
                 <tr>
                  <td valign="top" align="left">
                   <div class="pc-font-alt" style="line-height: 21px; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                    <div><span>Dear {{ $data['name'] ?? 'User' }}, <br/><br/>You requested to reset your password. Click the button below to continue:<br/><br/><a href="{{ $data['url'] }}" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; border-radius: 4px;">Reset Password</a><br/><br/> If you did not request a password reset, please ignore this email.<br><br> Please feel free to reach out if you have any questions or need assistance. <br/><br/>Here’s to a successful partnership! <br/><br/>Best regards, <br/>Curtains and Blinds <br/>support@curtainsandblinds.in</span>
                    </div>
                   </div>
                  </td>
                 </tr>
