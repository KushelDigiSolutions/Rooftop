                 ...
                 <tr>
                  <td valign="top" align="left">
                   <div class="pc-font-alt" style="line-height: 21px; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                    ...
                    Appointment ID : {{ $appointment['uniqueid'] }}<br/>as desired, we have rescheduled your appointment with Name {{ $franchiseName }} for {{ $appointmentDate }} at {{ $appointmentTime }} at {{ $appointment['address'] }}, {{ $appointment['city'] }}, {{ $appointment['state'] }}, {{ $appointment['pincode'] }} - {{ $appointment['country'] }}. We look forward to meeting you.
