                 ...
                 <tr>
                  <td valign="top" align="left">
                   <div class="pc-font-alt" style="line-height: 21px; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                    <div><span>Dear  {{ $user->name }}, <br>We are happy to inform you that your franchise account has been <strong>activated<br/>You can now access your dashboard and continue your operations.<br/><br/>Best regards, <br/>Curtains and Blinds <br/>support@curtainsandblinds.in</span>
                    </div>
                   </div>
                  </td>
                 </tr>
