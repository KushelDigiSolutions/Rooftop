                 ...
                 <tr>
                  <td valign="top" align="left">
                   <div class="pc-font-alt" style="line-height: 21px; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 15px; font-weight: normal; font-variant-ligatures: normal; color: #333333; text-align: left; text-align-last: left;">
                    <div><span>Dear {{ $appointment->name ?? 'User' }},<br/> 
                    We regret to inform you that your appointment (ID: {{ $appointment->uniqueid }}) has been <strong>rejected</strong>.<br/>
                    If you have any questions or need further assistance, please contact our support team.<br/><br/>Best regards, <br/>Curtains and Blinds <br/>support@curtainsandblinds.in</span>
                    </div>
                   </div>
                  </td>
                 </tr>
