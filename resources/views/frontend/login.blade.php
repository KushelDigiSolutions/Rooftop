<!DOCTYPE html>
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ url('assets') }}/" data-template="vertical-menu-template" data-style="light"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="{{ url('assets/css2') }}" rel="stylesheet">

    <!-- Icons -->
    <link rel="stylesheet" href="{{ url('assets/boxicons.css') }}">
    <link rel="stylesheet" href="{{ url('assets/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ url('assets/flag-icons.css') }}">
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ url('assets/perfect-scrollbar.css') }}">
    <link rel="stylesheet" href="{{ url('assets/typeahead.css') }}"> 
    <!-- Vendor -->
<link rel="stylesheet" href="{{ url('assets/form-validation.css') }}">

    <!-- Page CSS -->
    <!-- Page -->
<link rel="stylesheet" href="{{ url('assets/page-auth.css') }}">

    <!-- Helpers -->
    <script src="{{ url('assets/helpers.js') }}"></script><style type="text/css">
...
<script src="{{ url('assets/perfect-scrollbar.js') }}"></script>
<script src="{{ url('assets/hammer.js') }}"></script>
<script src="{{ url('assets/i18n.js') }}"></script>
<script src="{{ url('assets/typeahead.js') }}"></script>
<script src="{{ url('assets/menu.js') }}"></script>

<!-- endbuild -->

<!-- Vendors JS -->
<script src="{{ url('assets/popular.js') }}"></script>
<script src="{{ url('assets/bootstrap5.js') }}"></script>
<script src="{{ url('assets/auto-focus.js') }}"></script>

<!-- Main JS -->
<script src="{{ url('assets/main.js') }}"></script>

<!-- Page JS -->
<script src="{{ url('assets/pages-auth.js') }}"></script>
