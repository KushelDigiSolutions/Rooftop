...
@section('header_img')
<img class="header-img wow animate__animated animate__fadeIn" src="{{ url('frontend/images/franchise-bg.jpg') }}" style="width: 100% !important;" alt="">
@endsection
@section('hero')
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 d-flex justify-content-center align-items-center wow animate__animated animate__fadeIn">
                <img src="{{ url('frontend/images/india-map.svg') }}" class="img-fluid" alt="">
            </div>
...
<section class="ourstory wrapper">
    <div class="container">
        <div class="row wow animate__animated animate__fadeIn">
            <div class="col-md-6 wow animate__animated animate__fadeIn">
                <img src="{{ url('frontend/images/storyLeftImg.png') }}" class="img-fluid" alt="">
            </div>
...
<div class="bg-white">
    ...
    <div class="row mt-4 founderMessage">
        <div class="col-md-3 wow animate__animated animate__fadeIn">
            <div class="card teamCard mb-4">
                <img src="{{ url('frontend/images/p1.png') }}" alt="" class="img-fluid">
    ...
    <div  class="row mt-4 founderMessage founderMessage2">
        <div class="col-md-9 messageContent">
            <p class="text-justify">Raghav Sharma is a key figure in shaping and steering a company's brand identity, market positioning, and overall marketing strategy. With a deep understanding of consumer behavior and market trends, he works tirelessly to ensure that the brand resonates with its target audiences and fosters long-term customer loyalty. Raghav plays an instrumental role in crafting campaigns that not only capture attention but also builds meaningful connections with consumers. His strategic vision and leadership are crucial in differentiating the brand in a competitive market, driving growth, and enhancing brand value over time.</p>
            <p class="text-justify">
                His Belief - At Curtains and Blinds, there is one thing we will never compromise on: delivering a high-quality, budget friendly product paired with personalized service. We understand that your home or office is a reflection of your unique style, which is why we are committed to offering products that not only meet the highest standards of craftsmanship but also fit within your budget. With us, you can count on exceptional value, professional guidance, and a level of care that makes your experience truly special.
            </p> 
        </div>
        <div class="col-md-3 wow animate__animated animate__fadeIn">
            <div class="card teamCard mb-4">
                <img src="{{ url('frontend/images/p2.png') }}" alt="" class="img-fluid">
                <div class="card-content text-center">
    ...
    <!--    <div class="col-md-3 wow animate__animated animate__fadeIn">-->
    <!--        <div class="card teamCard mb-4">-->
    <!--            <img src="{{ url('frontend/images/p3.png') }}" alt="" class="img-fluid">-->
    <!--            <div class="card-content text-center">-->
    ...
    <!--    <div class="col-md-3 wow animate__animated animate__fadeIn">-->
    <!--        <div class="card teamCard mb-4">-->
    <!--            <img src="{{ url('frontend/images/p4.png') }}" alt="" class="img-fluid">-->
    <!--            <div class="card-content text-center">-->
    ...
    <!--    <div class="col-md-3 wow animate__animated animate__fadeIn">-->
    <!--        <div class="card teamCard mb-4">-->
    <!--            <img src="{{ url('frontend/images/p5.png') }}" alt="" class="img-fluid">-->
    <!--            <div class="card-content text-center">-->
    ...
    <!--    <div class="col-md-3 wow animate__animated animate__fadeIn">-->
    <!--        <div class="card teamCard mb-4">-->
    <!--            <img src="{{ url('frontend/images/p6.png') }}" alt="" class="img-fluid">-->
    <!--            <div class="card-content text-center">-->
