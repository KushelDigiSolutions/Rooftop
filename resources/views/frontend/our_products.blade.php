    ...
    <div class="container">
        <div class="row mt-4 align-items-center">
            <div class="col-md-5 wow animate__animated animate__fadeIn m-auto align-items-center">
                <img src="{{ url('frontend/images/img-9.png') }}" class="img-fluid" alt="">
            </div>
...
<section class="bg-white wrapper">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 wow animate__animated animate__fadeIn">
                <img src="{{ url('frontend/images/img-8.png') }}" class="img-fluid" alt="" class="img-fluid" alt="">
            </div>
        </div>
    </div>
</section>
...
<section class="container wrapper">
    <div class="row align-items-center">
        <div class="col-md-6 mb-3 wow animate__animated animate__fadeIn">
            <img src="{{ url('frontend/images/img-10.png') }}" class="img-fluid" alt="">
        </div>
        <div class="col-md-6 wow animate__animated animate__fadeIn">
